...
class LandWeek(models.Model):
    ...
    l_flock_id = fields.Many2one('flock.model', string="اسم السلاله")
...
class WLandWeek(models.Model):
    ...
    l_flock_id_ww = fields.Many2one('flock.model', string="اسم السلاله")
...
class BatteryWeek(models.Model):
    ...
    b_flock_id = fields.Many2one('flock.model', string="اسم السلاله")
...
class WBatteryWeek(models.Model):
    ...
    b_flock_id_ww = fields.Many2one('flock.model', string="اسم السلاله")
