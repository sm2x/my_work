...
class ommat_catalogue(models.Model):
    ...
    flock_id = fields.Many2one('flock.model', string="إسم السلاله", required=True)
    ...
    dynasty = fields.Many2one('dynasty.model', string='رقم القطيع')
    ...
    date_to_first_week = fields.Date('إلى اول اسبوع')
    ...
    def land_get_rested_ommat(self):
        ...
        for week in self.land_week_ids:
            ...
            if week.l_code == 1:
                ...
                # print('اول علف = الباقى - نسبة االعلف', x, week.l_scraped_ommat_f)
                week.l_e_daily_feed_m = week.l_rested_ommat_m * week.l_daily_feed_m
    ...
    def bat_get_rested_ommat(self):
        ...
        for week in self.bat_week_ids:
            ...
            if week.b_code == 1:
                ...
                # print('اول علف = الباقى - نسبة االعلف', x, week.b_scraped_ommat_f)
                week.b_e_daily_feed_m = week.b_rested_ommat_m * week.b_daily_feed_m
    ...
    def bat_ww_get_rested_ommat(self):
        ...
        for week in self.w_bat_week_ids:
            ...
            if week.b_code == 1:
                ...
                # print('اول علف = الباقى - نسبة االعلف', x, week.b_scraped_ommat_f)
                week.b_e_daily_feed_m_ww = week.b_rested_ommat_m_ww * week.b_daily_feed_m_ww
